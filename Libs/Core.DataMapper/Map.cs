...
namespace Core.DataMapper
{
    internal sealed class Map : IMap
    {
        ...
        /// <param name="destination"></param>
        /// <returns></returns>
        public IMap Add<TSourceMember, TDestinationMember>(TSourceMember source, TDestinationMember destination, bool isComplex)
            where TSourceMember : MemberInfo
            where TDestinationMember : MemberInfo
        {
            return AddItem<TSourceMember, TDestinationMember>(source, destination, isComplex);
        }
